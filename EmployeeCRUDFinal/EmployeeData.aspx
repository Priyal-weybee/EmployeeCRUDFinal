 ...
 <form id="form1" runat="server">
        ...
        <table class="auto-style1">
          ...
          <%--  <tr>
                ...
                <td>
                    <asp:CheckBox ID="isActive" runat="server" Checked="True" Text="Is Active" S/>
                </td>
            </tr>--%>
            <tr>
        ...
        <%-- <asp:GridView ID="GridView1"  runat="server" DataKeyNames="EmployeeId"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" Height="301px"   Width="447px"  onRowDeleting="DeleteRowButton_Click" OnRowEditing="EditButton_Click" OnRowCancelingEdit="RowCancelButton_Click" OnRowUpdating="RowUpdateButton_CLick" >
            
  </asp:GridView>--%>
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="true"  DataKeyNames="EmployeeId"   OnRowCancelingEdit="RowCancelButton_Click" OnRowDeleting="DeleteRowButton_Click" OnRowEditing="EditButton_Click" OnRowUpdating="RowUpdateButton_CLick"  >  
                    <Columns>  
